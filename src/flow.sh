...
#if [ $# -ne 6 ]                                                                                                                                                
#then
#    echo "usage: ./exec_sim.sh [n loop] [start run] [l_length] [r_length] [position] [step]"
#    exit 1
#fi

./execute.out 210 ../include/BRECON_MOM_20200716_6.txt /home/hideharu/position/result/pos/run0000.dat /home/hideharu/position/result/pos/environment_run0000.dat
